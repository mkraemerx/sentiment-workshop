...
c.NotebookApp.certfile = u'/etc/letsencrypt/live/letsencrypt-cert/fullchain.pem'
c.NotebookApp.keyfile = u'/etc/letsencrypt/live/letsencrypt-cert/privkey.pem'
...
c.NotebookApp.password = 'sha1:891948ea4ee4:f51d86ddceb00153b4b7d6be4a1080c3cd2e006e'
c.NotebookApp.ip = '*'
